        ...
        <div class="modal-body">
            <div class="row">
              ...
              <div class="form-group col-md-6">
                ...
                <input type="text" autocomplete="off" name='data_nasc' class="form-control" id="data_nasc" placeholder="Data de nascimento" required>
              </div>
              <div class="form-group col-md-6">
                <label for="CPF">CPF</label>
                <input type="text" autocomplete="off" name='CPF' class="form-control" id="CPF" placeholder="CPF" required>
              </div>
              <div class="form-group col-md-6">
              ...
              <div class="form-group col-md-12">
                ...
                <input type="text" autocomplete="off" required name='endereco' class="form-control" id="endereco" placeholder="Endereço" required>
              </div>
              <div class="form-group col-md-12 text-center">
                <label for="foto">Foto do paciente</label>
                <input type="file" autocomplete="off"  name='foto' class="form-control" id="foto" placeholder="Foto do paciente"  onchange="document.getElementById('imgspace').src = window.URL.createObjectURL(this.files[0])">
